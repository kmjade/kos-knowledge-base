...
| ID    | 任务                                                                                                               | 对应设计     | 状态  | 优先级 |
| ----- | ---------------------------------------------------------------------------------------------------------------- | -------- | :-: | :-: |
| UC-01 | **DDC→UDC 主映射表** — 建立 13 子库的 DDC→UDC 基础号映射表文件 `_meta/system/config/DDC-UDC 映射表.md`                                     | §4.1     |  ✅  | P0  |
...
| ID | 任务 | 对应设计 | 状态 | 优先级 |
|----|------|----------|:----:|:------:|
| UC-20 | **#udc/ 标签树同步** — 将 `_meta/system/config/UDC 標籤體系.md` 的标签树与现有 DDC 子库做差异对比，补全缺失标签 (21 tags added) | §6.1 | ✅ | P0 |
...
| UC-24 | **UDC 标签使用规范文档** — 创建 `_meta/system/config/UDC 标签使用指南.md`，包含标签命名规则、复合标签语法、使用示例 | §6.3 | ✅ | P2 |
...
| ID | 任务 | 对应设计 | 状态 | 优先级 |
|----|------|----------|:----:|:------:|
| UC-40 | **CLC 映射表** — 建立核心概念的 DDC↔CLC 映射 (聚焦 000/100/500/600/900 活跃子库)，写入 `_meta/system/config/CLC 映射表.md` | §7.1-7.2 | ✅ | P1 |
| UC-41 | **LCC 映射表** — 建立核心概念的 DDC↔LCC 映射 (同上范围)，写入 `_meta/system/config/LCC 映射表.md` | §7.1-7.2 | ✅ | P2 |
...
- [[_meta/system/config/UDC 標籤體系.md]] — UDC 标签体系 (现有)
