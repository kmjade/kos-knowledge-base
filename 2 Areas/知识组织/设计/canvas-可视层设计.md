...
```
python3 _meta/system/scripts/wiki-lock.py acquire _attachments/canvases/target.canvas
... 鍐欏叆鎿嶄綔 ...
python3 _meta/system/scripts/wiki-lock.py release _attachments/canvases/target.canvas
```
...
| [[_meta/architecture/design/KOS-LLM-Wiki鏋舵瀯璇存槑v3.0.md]] | 褰撳墠鏋舵瀯鏂囨。 |
