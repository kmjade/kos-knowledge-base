...
**KOS (Knowledge Operating System) — 智合** — v3.0.1

PARA × UDC × AI — 百惠科技出品的三语言知识操作系统
...
- `WIKI.md` — Vault 入口
- `AGENTS.md` — AI 行为规范
- `_meta/index/links/MOCs/MOCs.md` — 内容地图（MOC）导航
- [claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian) — KOS 系统的前身与灵感来源，由 AgriciDaniel 开发的 AI 驱动 Obsidian 知识管理系统
