...
- ❌ 日常对话与闲聊
- ❌ 三支柱（生活/学习/工作）目标追踪（由 [[../../_meta/ai/agents/life/协作者.md]] 负责）
- ❌ 趋势报告生成（由 [[../../_meta/ai/agents/life/分析师.md]] 负责）
- ❌ 晨间简报（由 [[../../_meta/ai/agents/life/简报员.md]] 负责）
...
| 操作 | 日志位置 |
|------|---------|
| Triage | `_meta/system/logs/operations/triage.md` |
| Compile | `_meta/system/logs/operations/compile.md` |
| Link 检查 | `_meta/system/logs/reports/` |
| Daily / Review | `_meta/system/logs/operations/maintenance.md` |
...
2. 检查 `_meta/system/logs/operations/` 最近操作状态
3. 扫描 `0 Inbox/` 待处理文件数
...
2. 操作日志写入 `_meta/system/logs/operations/maintenance.md`
...
- [[../../_meta/ai/skills/skills.md]] — 全部技能索引
- [[../../_meta/architecture/design/skills体系分析.md]] — Skills 体系现状
- [[../../_meta/architecture/design/claude-obsidian分析.md]] — claude-obsidian 参考项目
