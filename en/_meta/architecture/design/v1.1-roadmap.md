...
| Audit Logs (_meta/system/logs/) | ✅ | AI-Log/ localized |
...
- Output: target directory + `_meta/system/logs/operations/triage.md`

**Deliverables:**
- `AGENTS.md` — New KOS-Triage rules section
- `_meta/system/logs/operations/triage.md` — First triage operation log
...
- Aggregate weekly operations from `_meta/system/logs/operations/`
- Summarize Wiki changes
- Generate weekly report to `_meta/system/logs/reports/weekly.md`
...
### Session End
1. Write session log to _meta/system/logs/sessions/
2. Update operation logs in _meta/system/logs/operations/
...
| Session context loss | Medium | Low | _meta/system/logs/sessions/ provides history recovery |
