...
| Current | Target |
|---------|--------|
| `3 Resources/LLM-Wiki/` | `3 Resources/LLM-Wiki/raw/` + `3 Resources/LLM-Wiki/wiki/` |
| `3 Resources/PARA/` | `3 Resources/PARA/raw/` + `3 Resources/PARA/wiki/` |
| `3 Resources/UDC/` | `3 Resources/UDC/raw/` + `3 Resources/UDC/wiki/` |
...
#### 3.1 Lint System Check

```yaml
/lint                      # Run system health check
/lint --fix                # Auto-fix fixable items
/lint --verbose            # Detailed report
```
